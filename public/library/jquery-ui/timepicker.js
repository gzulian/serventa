...
(function (factory) {
	...
	*/
	var Timepicker = function () {
		this.regional = ['esp']; // Available regional settings, indexed by language code
		this.regional['esp'] = { // Default regional settings
			currentText: 'Ahora',
			closeText: 'Ok',
			amNames: ['AM', 'A'],
			pmNames: ['PM', 'P'],
			timeFormat: 'HH:mm',
			timeSuffix: '',
			timeOnlyTitle: 'Selecciona un hora',
			timeText: 'Hora',
			hourText: 'Hora',
			minuteText: 'Minuto',
			secondText: 'Segundo',
		...
		$.extend(this._defaults, this.regional['esp']);
	};

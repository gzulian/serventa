...
<html>  
    <head>
        ...
        <?php echo $__env->make('includes.jquery-ui', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <link rel="stylesheet" href="<?php echo e(URL::asset('/library/autocomplete/style.css')); ?>">
        <script src="<?php echo e(URL::asset('/library/autocomplete/typeahead.min.js')); ?>" type="text/javascript"></script>
        <script src="<?php echo e(URL::asset('/js/Moment.js')); ?>" type="text/javascript"></script>
        <script src="<?php echo e(URL::asset('/js/addDateTimepicker.js')); ?>" type="text/javascript"></script>
        ...
        $(function(){
          ...
          $('#param').typeahead({
            name: 'service',
            // data source
            prefetch: "<?php echo e(url('/search')); ?>",
    ...
    <script src="<?php echo e(URL::asset('/template/assets/plugins/counter/jquery.countTo.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('/template/assets/plugins/filestyle/bootstrap-filestyle.min.js')); ?>"></script>
    <script type="text/javascript">
